...
Studentin/Student          &    Max Knauber\\
                           &    Matthias Gass\\[2ex]
                           &    Fabian Schenker\\[2ex]
Expertin/Experte           &    ?\\[2ex]
Fachbetreuer/in            &    Silvan Wirth\\[2ex]
...
\begin{tikzpicture}[remember picture,overlay,every node/.style={anchor=north west}]
  \node at (current page.north west) [xshift=0.5cm, yshift=-0.5cm] {\includegraphics[width=20cm]{logo_mit_schulen.png}};
\end{tikzpicture}
